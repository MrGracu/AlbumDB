...
namespace AlbumDB.FORMS
{
    public partial class WytworniaForm : Form
    {
        ...
        public WytworniaForm(bool mode, int id)
        {
            InitializeComponent();
            modeForm = mode;
        ...
        public void loadValueFromQuery()
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(conString))
            {
                ...
                using (OleDbCommand cmd = new OleDbCommand("SELECT nazwa FROM wytwornia WHERE ID=" + IDToSQLQuery, conn))
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (InsertIntoDatabase.Insert("wytwornia", textBox1.Text, modeForm, IDToSQLQuery))
            {
