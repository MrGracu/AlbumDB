...
namespace AlbumDB
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string conString = @"Provider=Microsoft.Jet.OLEDB.4.0;" + "Data Source=D:\\GitHub\\source\\repos\\AlbumDB\\AlbumDB\\albumy_muz.mdb;" + "Persist Security Info=True;" + "Jet OLEDB:Database Password=;";
