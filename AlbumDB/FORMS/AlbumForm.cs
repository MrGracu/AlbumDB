...
namespace AlbumDB.FORMS
{
    public partial class AlbumForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text.Length == 0 || richTextBox1.Text.Length == 0 || numericUpDown1.Value == 0 || dateTimePicker2.Value.TimeOfDay <= date1.TimeOfDay || numericUpDown3.Value == 0 || numericUpDown5.Value == 0 || numericUpDown4.Value == 0)
            {
